...
| Status | Provisional PRD mirror — `hypothesis` mode |
| Related requirements / ADRs | RUB-02; E-BC-04; D-005, D-006; continuity_requirements.csv |
| Prompt alignment | `prompts/03_prd_vision.md`; mirrors `prompt_spine/03_prd/{vision,prd,scope_in_out}.md` |
...
**Working title:** AEGIS Evidence Assist (from `prompt_spine/03_prd/vision.md`).
...
| Scope hygiene | In/out locked in `prompt_spine/03_prd/scope_in_out.md`; later prompts must not silently pull exclusions | Product | Prompt 03 exit criteria |
...
|---|---|---|---|---|
| Intended/prohibited uses | Product law + schemas | Contract negatives; authz tests | `submission/artefacts/04_PRODUCT_SERVICE_BLUEPRINT.md` | Phase 1 complete |
