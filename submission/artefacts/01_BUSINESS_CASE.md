...
| Status | Provisional — Prompt 01 framing mode `hypothesis` |
...
**Prompt spine citations:** `submission/artefacts/prompt_spine/01_discovery/`; `…/02_scqa/scqa_minto_decision_narrative.md`.
...
|---|---|---|---|---|
| Qualify the problem (Prompt library §1) | SCQA + this business case | Phase 1 prompt revise | `prompt_spine/02_scqa/scqa_minto_decision_narrative.md` | Aligned |
| Sufficiency / framing mode | Prompt 01 register | Hypothesis until P0 backlog | `prompt_spine/01_discovery/evidence_register.md` | `hypothesis` |
| Measurable problem + no-AI challenge | Business case + DMAIC | Phase 1 review | `submission/artefacts/01_BUSINESS_CASE.md` | Provisional complete |
