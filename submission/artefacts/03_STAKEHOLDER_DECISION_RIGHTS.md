...
| Status | Provisional under `hypothesis` framing |
...
**Cited:** `prompt_spine/01_discovery/evidence_register.md` §5; `prompt_spine/03_prd/prd.md` §1.
...
|---|---|---|---|---|
| Human oversight & decision rights | RACI + authz gateway | Authz deny tests (Phase 3+) | `submission/artefacts/03_STAKEHOLDER_DECISION_RIGHTS.md` | Phase 1 complete |
