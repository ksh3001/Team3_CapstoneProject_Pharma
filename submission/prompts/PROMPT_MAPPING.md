...
- Do **not** create parallel working folders, extra prompt-output markdown trees, or alternate artefact names.
...
- Team prompts may *prepare content* for a later artefact, but files are created only in the workshop stage that owns them.
