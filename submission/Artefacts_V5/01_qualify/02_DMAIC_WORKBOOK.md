...
| Phase status | Phase 1 complete — see `PHASE1_CHECKPOINT.md` |
| Reviewers | Architecture lead; GxP lead |
| Status | Phase 1 complete (v0.3) — Define/Measure sketch; full Lean consolidated in prompt track |
| Related requirements / ADRs | RUB-01, RUB-03; INJ-001…006; D-006 |
| Prompt alignment | Thin lenses: `artefacts/prompts/01_discovery|02_scqa|03_prd/dmaic_lens.md`; full workshop: `artefacts/prompts/09_lean_dmaic/` |
...
**Thin lenses cited:** `prompts/01_discovery/dmaic_lens.md`, `…/02_scqa/dmaic_lens.md`, `…/03_prd/dmaic_lens.md`. Early wastes: `…/01_discovery/early_waste_signals.md`.
...
|---|---|---|---|---|
| Thin DMAIC lenses 01–03 | canonical prompts/ dmaic_lens files | Prompt exit criteria | `prompts/01_discovery|02_scqa|03_prd/dmaic_lens.md` | Complete |
| Full Lean/DMAIC workshop | Prompt 09 consolidation | Later phase | `prompts/09_lean_dmaic.md` | Deferred |
| DMAIC + benefits path | This workbook + business case | Phase 1 checkpoint | `submission/artefacts/phases/01_qualify/02_DMAIC_WORKBOOK.md` | Provisional |
